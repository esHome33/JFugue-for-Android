...
public class Intervals implements PatternProducer, NoteProducer
{
	...
	/**
	 * Fournit les notes � partir du pattern de cet intervalle.
	 */
	@Override
	...
	/**
	 * Fournit les notes mais en s'assurant de la coh�rence des b�mols et des di�ses dans le pattern. Cette fonction 
	 * r�pond mieux � mes besoins que la fonction {@link #getNotes()} standard de jFugue, qui fournit les notes 
	 * brutalement � partir du Pattern.
	 *  
	 * @author Etienne
	 * @param disposition +1 si on veut des notes avec des # et -1 si on veut des notes avec des b�mols.
	...
	/**
	 * Fournit les notes demand�es de cet intervalle (sans indication d'octave). 
	 * La demande se fait via le param�tre.
	 * Si une note demand�e n'est pas pr�sente, le tableau de retour sera vide ou comportera 
	 * moins d'�l�ments que le nombre demand�.
	 * <br><br>
	 * ATTENTION : il faut que l'intervalle ait une root note !
	 * 
	 * @param notes_number chaine qui contient le num�ro (base 1) des notes souhait�es s�par�es par 
	 * 			des espaces. Exemple : "1 3 5"
	 * 			pour demander les notes n�1, n�3 et n�5 de cet intervalle. Si l'intervalle contient moins de 
	 * 			5 notes, le retour sera limit� aux notes trouv�es.
	 * @return un tableau contenant les notes demand�es sans octave lorsqu'elles ont �t� trouv�es 
	 * 			dans cet intervalle (peut �ventuellement �tre un tableau vide).
	 * @author Etienne
	 */
