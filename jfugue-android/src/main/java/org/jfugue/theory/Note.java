...
//		this.originalString = null;
	...
	/**
	 * utilise le compte d'accidents pour donner une repr�sentation des accidents
	 * @author Etienne
	 * @param nombre le nombre d'accidents (-2 correspond � 2 b�mols, 0 � aucun accident et 1 � un di�se
	 * @return l'accident correspondant au nombre indiqu�
	 */
	...
	public Note addInterval(Interv intervalle) {
		...
		// pour d�terminer l'accident de la note d'arriv�e, on va cr�er un intervalle et voir s'il manque
		// quelque chose pour avoir les halfsteps demand�s.
		...
		// en fonction du delta, on ajoute un b�mol ou un di�se
		String nv_acc;
		if(delta > 1) {
			nv_acc = "BB";
		} else if(delta > 0) {
    ...
    public static enum Interv {
		...
		/**
		 * retrouve le nom de l'intervalle � l'aide de l'�cart entre notes et nombre de 1/2 tons.
		 * @param ecart_note
		 * @param num_halfsteps
